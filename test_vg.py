...
from engine import evaluate, test_one_epoch
...
def main(args):
    ...
    test_dataset = []
    with open(dataset_meta['train'][0]['anno'], 'r', encoding='utf-8') as file:
        for line in file:
            test_dataset.append(json.loads(line.strip()))
    dataset_leng = len(test_dataset)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = test_one_epoch(model, data_loader_train, dataset_leng, device=0, epoch=1)
