...
class Transformer(nn.Module):
    def __init__(
        ...
        self.encoder = TransformerEncoder(
            ...
            lm_fusion_layer = lm_fusion_layer,
...
class TransformerEncoder(nn.Module):
    def __init__(
        ...
        if num_layers > 0:
            ...
            if feature_fusion_layer is not None:
                ...
                self.lm_fusion_layers = _get_clones(
                    lm_fusion_layer, 1, layer_share=enc_layer_share
                )
        else:
            self.layers = []
            del encoder_layer
    ...
    def forward(
        ...
        memory_text = self.lm_fusion_layers[0](
                    v=output,
                    l=memory_text,
                    attention_mask_v=key_padding_mask,
                    attention_mask_l=text_attention_mask,
