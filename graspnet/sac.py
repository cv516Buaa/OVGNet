...
class ViLG(object):
    ...
    def get_fusion_feature(self, bboxes, pos_bboxes, text, actions):
        ...
        #vilg_feature 16个抓取姿势的交叉注意力  clip_probs语言和8个物体的相似度
        #actions就是remaingrasp
    ...
    def update_parameters(self, memory, batch_size, updates):
        ...
        with torch.no_grad():
            ...
            #下一次抓取的所有抓取姿势的视语抓取交叉注意力，上一个是16，现在是11个抓取姿势
            logits = self.policy(next_sa)#下一次抓取的
